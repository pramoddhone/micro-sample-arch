...
import com.nitor.skill.config.audit.AuditEventConverter;
import com.nitor.skill.domain.PersistentAuditEvent;
...
import static com.nitor.skill.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
